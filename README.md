...
<p align="center">
  ...
  <br/><br/>
  <kbd>
    <img width="250" style="border-radius: 5px" height="450" src="screenshots/7.png" alt="7">
  </kbd>
    &nbsp;&nbsp;&nbsp;&nbsp;
  <kbd>
    <img width="250" style="border-radius: 5px" height="450" src="screenshots/8.png" alt="8">
  </kbd>
    &nbsp;&nbsp;&nbsp;&nbsp;
  <kbd>
    <img width="250" style="border-radius: 5px" height="450" src="screenshots/9.png" alt="9">
  </kbd>
</p>
